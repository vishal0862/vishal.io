    ...
    <body>
        ...
        <header id="home">
            <div class="overlay">
                <div class="container">
                    <div>
                        <h1><span>Amazing</span><br>Tour of great India</h1>
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-12 text-right">
                                <h4 class="text-uppercase">Enjoy <span>holiday</span></h4>
        ...
        <footer>
            <div class="container">
                <ul>
                    <li><a href="https://www.facebook.com/vishal.chaturvedi84742580"><i class="fab fa-facebook-f"></i></a></li>
                    <li><a href="https://twitter.com/vishalc90382755"><i class="fab fa-twitter"></i></a></li>
                    <li><a href="https://www.linkedin.com/in/vishal-chaturvedi-a944951aa/"><i class="fab fa-linkedin-in"></i></a></li>
                </ul>
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-12">
                        <div class="item">
            ...
            <div class="copyright text-center">
                <p>Copyright 2021 Designed by <a href="https://html.design"> vishal chaturvedi </a></p>
            </div>
        </footer>
